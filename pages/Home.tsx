              ...
              <div className="flex-1 grid grid-cols-1 md:grid-cols-3 w-full divide-y md:divide-y-0 md:divide-x divide-white/10">
                  <div className="px-6 py-4 hover:bg-white/5 transition-colors group cursor-pointer w-full">
                     ...
                     <div className="flex items-center gap-2">
                        ...
                        <input type="date" onChange={(e) => setCheckIn(e.target.value)} className="bg-transparent text-white w-full outline-none font-serif text-lg placeholder-white/50" />
                     </div>
                  </div>
                  ...
                  <div className="px-6 py-4 hover:bg-white/5 transition-colors group cursor-pointer w-full">
                     ...
                     <div className="flex items-center gap-2">
                        <Calendar className="w-4 h-4 text-white/30" />
                        <input type="date" onChange={(e) => setCheckOut(e.target.value)} className="bg-transparent text-white w-full outline-none font-serif text-lg placeholder-white/50" />
                     </div>
                  </div>
